...
// ===================================
export const departement = (req, res) => {
  const db = getDB();
...
// ===================================
// Liste des enseignants pour le département Maths
// ===================================
export const departement_math = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département Maths
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
export const departement_lettres = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des utilisateurs dans le département Lettres
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
export const departement_anglais = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des utilisateurs dans le département Anglais
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département SHSPhilo
// ===================================
export const departement_shsphilo = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département SHSPhilo
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département Documentation
// ===================================
export const departement_documentation = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département Documentation
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département HistGéo
// ===================================
export const departement_histgeo = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département HistGéo
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département EPS
// ===================================
export const departement_eps = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département EPS
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département SVT
// ===================================
export const departement_svt = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département SVT
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département Espagnol
// ===================================
export const departement_espagnol = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département Espagnol
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département Musique
// ===================================
export const departement_musique = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département Musique
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département Allemand
// ===================================
export const departement_allemand = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département Allemand
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département Arts Plastiques
// ===================================
export const departement_artsplastiques = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département Arts Plastiques
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département SPC
// ===================================
export const departement_spc = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département SPC
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département Techno
// ===================================
export const departement_techno = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département Techno
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département Arch
// ===================================
export const departement_arch = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département Arch
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département Ash
// ===================================
export const departement_ash = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département Ash
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département Italien
// ===================================
export const departement_italien = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département Italien
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
...
// ===================================
// Liste des enseignants pour le département Écogestion
// ===================================
export const departement_ecogestion = (req, res) => {
  const db = getDB();
  // Requête SQL pour récupérer la liste des enseignants dans le département Écogestion
  const sqlQuery = `
    SELECT 
      u.email AS Email,
      c.shortname AS Code,
